...
SOURCES = main.cpp Renderer.cpp Framebuffer.cpp ScreenQuad.cpp Plane.cpp Suzanne.cpp Dragon.cpp Object.cpp Skybox.cpp Light.cpp camera/Camera.cpp camera/Keyboard.cpp helpers/ProgramUtilities.cpp helpers/MeshUtilities.cpp helpers/lodepng/lodepng.cpp
