...
SOURCES = main.cpp Renderer.cpp Suzanne.cpp Skybox.cpp camera/Camera.cpp camera/Keyboard.cpp helpers/ProgramUtilities.cpp helpers/MeshUtilities.cpp helpers/lodepng/lodepng.cpp
