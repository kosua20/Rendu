...
layout(set = 2, binding = 2) uniform texture2D effectsTexture; ///< Effects map (sheeness in the G channel).
layout(set = 2, binding = 3) uniform texture2D sheenTexture; ///< Sheen color and roughness.
