...
void main(){
	...
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (-2 * right + -1 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (-2 * right +  1 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (-1 * right + -2 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (-1 * right +  0 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (-1 * right +  2 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (             -1 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * (              1 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * ( 1 * right + -2 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * ( 1 * right +  0 * up), layer), 0.0);
	color += textureLod(screenTexture, toCube(In.pos + invHalfSize * ( 1 * right +  2 * up), layer), 0.0);
