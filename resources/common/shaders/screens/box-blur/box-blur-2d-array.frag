...
layout(set = 1, binding = 0) uniform texture2DArray screenTexture; ///< Image to blur.
...
void main(){
	...
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2(-2,-1));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2(-2, 1));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2(-1,-2));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2(-1, 0));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2(-1, 2));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2( 0,-1));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2( 0, 1));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2( 1,-2));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2( 1, 0));
	color += textureLodOffset(sampler2DArray(screenTexture, sClampLinear), vec3(In.uv, layer), 0.0, ivec2( 1, 2));
