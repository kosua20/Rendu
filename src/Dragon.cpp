...
void Dragon::init(){
	...
	// Load geometry.
	mesh_t mesh;
	loadObj("ressources/dragon.obj",mesh,Indexed);
	...
	_texNormal = loadTexture("ressources/dragon_texture_normal.png", _programId, 1, "textureNormal");
	
	_texEffects = loadTexture("ressources/dragon_texture_ao_specular_reflection.png", _programId, 2, "textureEffects");
...
void Dragon::draw(float elapsed, const glm::mat4& view, const glm::mat4& projection, const size_t pingpong){
