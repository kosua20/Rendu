...
void Scene::init(){
	...
	objects.back().init(Object::Type::Regular, "suzanne", { {"suzanne_texture_color", true }, {"suzanne_texture_normal", false}, {"suzanne_texture_ao_specular_reflection", false} });
	objects.emplace_back();
	objects.back().init(Object::Type::Regular, "dragon", { { "dragon_texture_color", true }, { "dragon_texture_normal", false }, { "dragon_texture_ao_specular_reflection", false } });
	objects.emplace_back();
	objects.back().init(Object::Type::Parallax, "plane", { { "plane_texture_color", true }, { "plane_texture_normal", false }, { "plane_texture_depthmap", false } }, {}, false);
	background.init(Object::Type::Skybox, "skybox", {}, {{"corsica_beach_cube", true }});
	...
	objects[1].update(dragonModel);
	objects[2].update(planeModel);
}
